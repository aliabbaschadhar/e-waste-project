            ...
            {myRequests.map((request) => (
              <Card key={request.id}>
                <div className="p-6">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900">{request.foodItem}</h3>
                      <p className="text-gray-600">{request.restaurant}</p>
                    </div>
                    <Badge
                      variant={
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    <div>Quantity: {request.quantity}</div>
                    {request.pickupTime && <div>Pickup: {request.pickupTime}</div>}
                    <div>Requested: {request.requestedAt}</div>
                  </div>
                </div>
              </Card>
            ))}
