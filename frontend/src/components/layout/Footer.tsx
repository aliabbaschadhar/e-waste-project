        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Browse Food</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors">For Restaurants</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors">For Charities</a></li>
            </ul>
          </div>
