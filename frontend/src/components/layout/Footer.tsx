...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-linear-to-r from-gray-900 via-gray-800 to-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-2">Reducing waste, feeding communities</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
            ...
            <a href="#" className="hover:text-emerald-400 transition-colors">For Restaurants</a>
        ...
        <div className="border-t border-gray-700 mt-6 pt-6 text-center">
          <p className="text-xs text-gray-400">
            &copy; 2025 FoodShare. All rights reserved. Made with <span className="text-red-500">❤️</span> for a sustainable future.
          </p>
        </div>
      </div>
    </footer>
